...
const TopRatedS = () => {
  ...
  return (
    ...
    <div className="watchlist-container">
      <h2 className="watchlist-title">Top Rated Series</h2>
      <div className="watchlist-movies">
        {topRatedMovies.map((movie, index) => {
          const { id, name, poster_path, vote_average, release_date } = movie;
          ...
          return (
            <div className="watchlist-movie-card" key={id}>
              ...
              <div className="watchlist-movie-details">
                <h3 className="watchlist-movie-title">{ranking}. {name}</h3>
